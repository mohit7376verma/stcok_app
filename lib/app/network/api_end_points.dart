class ApiEndPoints {
  ...
  static const logout = "api/auth/v1/logout";
  static const getProfile = "api/auth/v1/getprofile";
  static const deleteAccount = "api/auth/v1/deleteaccount";
  static const updateProfile = "api/auth/v1/updateprofile";
