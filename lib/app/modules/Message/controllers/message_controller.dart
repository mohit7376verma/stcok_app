...
class MessageController extends GetxController {
  ...
  void onInit() {
    ...
    chatList.add(ChatModel(
        ...
        senderImage: "",
        type: "text",
        timeStamp: (formatDate((DateTime.now().millisecondsSinceEpoch - 60000).toString())).toString(),
        pushKey: ""));
    chatList.add(ChatModel(
        senderId: "id",
        receiverId: "",
        ...
        senderImage: "",
        type: "text",
        timeStamp: (formatDate((DateTime.now().millisecondsSinceEpoch).toString())).toString(),
        pushKey: ""));
